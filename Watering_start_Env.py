...
class WateringEnv(gym.Env):
    ...
    def reset(self, *, seed=None, options=None):
        ...
        # create observation:
        observation = [dron_x, dron_y, flower_delta_x, flower_delta_y,difficult_delta_x,difficult_delta_y,base_delta_x,base_delta_y] + list(self.prev_actions)
    ...
    def step(self, action):
        ...
        self.screen.blit(const.AGENT_ICON, (self.dron[1],
                                            self.dron[0]))
        self.screen.blit(const.FLOWER_ICON, (self.flower_position[1], self.flower_position[0]))
        ...
        if self.dron == self.difficult_position or Energy < 1:
        ...
        self.total_reward = ((250 - euclidean_dist_to_flower) + flower_reward + energy_reward )/100
